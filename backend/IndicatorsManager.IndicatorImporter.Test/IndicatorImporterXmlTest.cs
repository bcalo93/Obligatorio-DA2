...
using IndicatorsManager.IndicatorImporter.Xml;
...
namespace IndicatorsManager.IndicatorImporter.Test
{
    ...
    [TestClass]
    public class IndicatorImporterXmlTest
    {
        private const string xmlOkTest = @"C:\Users\Brahian\Documents\Facultad\Diseno 2\Obligatorio 2\backend\IndicatorsManager.IndicatorImporter.Test\testxmls\oktest.xml";
        private const string xmlWrongTest = @"C:\Users\Brahian\Documents\Facultad\Diseno 2\Obligatorio 2\backend\IndicatorsManager.IndicatorImporter.Test\testxmls\wrongtest.xml";

        [TestMethod]
        public void GetNameTest()
        {
            IndicatorImporterXml importer = new IndicatorImporterXml();
        ...
        public void GetParametersTest()
        {
            ...
            Assert.AreEqual("Text", parameters.ElementAt(0).Type);
